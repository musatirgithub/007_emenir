...
# DEBUG = True  # This part is moved to dev.py file
...
INSTALLED_APPS = [
    ...
    'dj_rest_auth',
    # 'debug_toolbar',          # This part is moved to dev.py file
]

MIDDLEWARE = [
    # "debug_toolbar.middleware.DebugToolbarMiddleware",                # This part is moved to dev.py file
